...
import 'package:instagram_clone_ver2/models/firestore/comment_model.dart';
...
import 'package:instagram_clone_ver2/repo/comment_network_repository.dart';
import 'package:instagram_clone_ver2/widgets/comment.dart';
      ...
      body: Form(
        ...
        child: Column(
          children: <Widget>[
            ...
            Divider(
              height: 1, thickness: 1, color: Colors.grey[400],
            ),
            Row(
              children: <Widget>[
                Expanded(
